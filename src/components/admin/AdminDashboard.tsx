...
import AddBorrowingRecord from './AddBorrowingRecord';
...
const AdminDashboard: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'borrow', label: 'Add Borrowing', icon: Plus, color: 'from-green-500 to-emerald-500' },
    { id: 'returns', label: 'Manage Returns', icon: RotateCcw, color: 'from-yellow-500 to-orange-500' },
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'borrow':
        return <AddBorrowingRecord onUpdate={loadStats} />;
      case 'returns':
      ...
      >
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-peacock-300">Export borrowing records and inventory data</p>
          </div>
          <motion.button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
          >
